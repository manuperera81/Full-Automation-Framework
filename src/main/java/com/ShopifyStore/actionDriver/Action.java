...
public class Action extends BaseClass  implements ActionInterface {
    ...
    public void enter(WebElement ele){
        ...
        try {
            ...
            System.out.println("Cannot use the RETURN Key");
            flag = false;
        } finally {
            if (flag) {
                System.out.println("Successfully use the RETURN Key");
            } else {
                System.out.println("Error occurred when using the RETURN Key");
            }
        }
    }
    ...
    /**
     * select value from Drop Down by using value
     *
     * @param element     : Action to be performed on element (Get it from Object
     *                    repository)
     *
 ...
 *
    ...
    public boolean mouseHoverByJavaScript(WebElement ele) {
        boolean flag = false;
        try {
            String javaScript = "let evObj = document.createEvent('MouseEvents')"
